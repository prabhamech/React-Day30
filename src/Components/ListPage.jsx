      ...
      <table className="table table-bordered px-2">
        <thead>
          <tr className="table-row">
            <th scope="col" className="colors text-black">S.No</th>
            <th scope="col" className="colors text-black">Name</th>
            <th scope="col" className="colors text-black">Email</th>
            <th scope="col" className="colors text-black">Phone</th>
            <th scope="col" className="colors text-black">Actions</th>
          </tr>
        </thead>
        <tbody>
          {data.map((user, index) => (
